...
EPISODES = [
    ...
    dict(id=1,  name="Аннексия Крыма",                      A=["RUS"], B=["UKR"], day="2014-02-27", prec=1, grp="A", state=True,
         note="27.02 — захват парламента Крыма людьми без опознавательных знаков; 20.02 из документа "
              "это дата на российской медали, а не день начала операции"),
    dict(id=2,  name="Война в Донбассе",                    A=["RUS"], B=["UKR"], day="2014-04-12", prec=1, grp="A", state=True,
         note="12.04 — захват Славянска группой Гиркина, пришедшей из России; "
              "участие кадровых частей есть, но формально через ДНР/ЛНР"),
    ...
    dict(id=5,  name="Наступление на Гому",                 A=["RWA"], B=["COD"], day="2025-01-23", prec=1, grp="A", state=True,
         note="вместо размытого «с 2022 года» взято наступление 23-30.01.2025: "
              "по данным ООН, на стороне М23 воевали 3-4 тыс. руандийских военных"),
    ...
    dict(id=11, name="Чумар",                               A=["IND"], B=["CHN"], day="2014-09-16", prec=1, grp="B", state=True),
    ...
    dict(id=25, name="Возобновление боёв, декабрь 2025",    A=["THA"], B=["KHM"], day="2025-12-07", prec=1, grp="B", state=True,
         note="07.12 — перестрелка, 08.12 — авиаудары Таиланда"),
    ...
    dict(id=29, name="Платформа HYSY-981",                  A=["CHN"], B=["VNM"], day="2014-05-01", prec=1, grp="C", state=True,
         note="01.05 — Вьетнам обнаружил платформу в спорных водах; столкновения судов "
              "береговой охраны, без боевых потерь"),
    dict(id=30, name="Сулеймани и удар по Айн-эль-Асад",    A=["USA"], B=["IRN"], day="2020-01-03", prec=1, grp="C", state=True),
    dict(id=31, name="Операция «Весенний щит»",             A=["TUR"], B=["SYR"], day="2020-02-27", prec=1, grp="C", state=True,
         note="27.02 — авиаудар по турецкой колонне в Балюне, 33 погибших, в тот же день начата операция"),
